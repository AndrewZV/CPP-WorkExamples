...
private:
	...
	/* Displayable Objects Vector */
	std::vector<DisplayableObject*> displayableObjectsVector;
	...
	bool m_bInsideDraw;
public:
	void DestroyObject(int iObjectIndex);
	DisplayableObject* getFirstElementInVector();
	int getObjectId(DisplayableObject* thisObject);
};
